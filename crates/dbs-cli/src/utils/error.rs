...
use crate::vmm::{address_space_manager, device_manager, resource_manager, vcpu, vm};
...
///
/// These errors cannot be generated by direct user input, but can result from bad configuration of
