...
pub enum InstanceState {
    /// Micro-VM is not initialized
    Uninitialized,
    /// Micro-VM is starting
    Starting,
    /// Micro-VM is running
    Running,
    /// Micro-VM is Paused
    Paused,
    /// Micro-VM received a halt instruction
    Halting,
    /// Micro-VM is halted
    Halted,
    /// Micro-VM exit instead of process exit.
    Exited(i32),
}
...
/// The type that contains general information about the microVM.
