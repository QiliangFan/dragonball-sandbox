...
use crate::utils::error::{Result, StartMicroVmError, StopMicrovmError, };
use crate::vmm::event_manager::EventManager;
use crate::vmm::vm::{CpuTopology, KernelConfigInfo, VmConfigInfo};
use crate::vmm::Vmm;
...
pub use crate::vmm::device_manager::blk_dev_mgr::{
    BlockDeviceConfigInfo, BlockDeviceConfigUpdateInfo, BlockDeviceError, BlockDeviceMgr,
};
#[cfg(feature = "virtio-fs")]
pub use crate::vmm::device_manager::fs_dev_mgr::{
    FsDeviceConfigInfo, FsDeviceConfigUpdateInfo, FsDeviceError, FsDeviceMgr, FsMountConfigInfo,
};
#[cfg(feature = "virtio-net")]
pub use crate::vmm::device_manager::virtio_net_dev_mgr::{
    VirtioNetDeviceConfigInfo, VirtioNetDeviceConfigUpdateInfo, VirtioNetDeviceError,
    VirtioNetDeviceMgr,
};
#[cfg(feature = "virtio-vsock")]
pub use crate::vmm::device_manager::vsock_dev_mgr::{VsockDeviceConfigInfo, VsockDeviceError};

use crate::utils::boot_source::*;
use crate::utils::machine_config::*;
use crate::utils::boot_source::BootSourceConfig;
...
impl VmmService {
    ...
    fn configure_boot_source(
        ...
        use crate::utils::boot_source::BootSourceConfigError::{
            InvalidInitrdPath, InvalidKernelCommandLine, InvalidKernelPath,
            UpdateNotAllowedPostBoot,
        };
        use self::VmmActionError::BootSource;
