...
use vm_memory::{
    guest_memory::{GuestAddress, GuestAddressSpace, GuestMemoryRegion, GuestUsize, MemoryRegionAddress, FileOffset},
    mmap::{GuestMemoryMmap, GuestRegionMmap, MmapRegion},
    Address
};

use super::resource_manager::ResourceManager;
use super::vm::NumaRegionInfo;
...
// Control the actual number of pre-allocating threads.
const PRE_ALLOC_GRANULARITY: u64 = 8;
