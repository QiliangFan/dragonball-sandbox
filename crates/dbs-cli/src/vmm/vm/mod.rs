...
use super::address_space_manager::{
    AddressManagerError, AddressSpaceMgr, AddressSpaceMgrBuilder, GuestAddressSpaceImpl,
    GuestMemoryImpl,
};

use crate::utils::info::{InstanceInfo, InstanceState};
use super::device_manager::console_manager::DmesgWriter;
use super::device_manager::{DeviceManager, DeviceMgrError, DeviceOpContext};
use crate::utils::error::{LoadInitrdError, Result, StartMicroVmError, StopMicrovmError};
use crate::vmm::event_manager::EventManager;
use crate::vmm::vcpu::{VcpuManager, VcpuManagerError};
use crate::vmm::resource_manager::ResourceManager;
use vmm::kvm_context::KvmContext;
#[cfg(target_arch = "aarch64")]
...
impl Vm {
    ...
    fn load_initrd<F>(
        ...
        where
            F: Read + Seek,
    {
        use crate::utils::error::LoadInitrdError::*;
